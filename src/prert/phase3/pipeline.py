...
def run_phase3_pipeline(
    ...
    privacybert_warmup_ratio: float = 0.1,
    ...
    model, training_summary = train_classifier(
        ...
        privacybert_loss_type=privacybert_loss_type,
        privacybert_focal_gamma=privacybert_focal_gamma,
        privacybert_label_smoothing=privacybert_label_smoothing,
        privacybert_weight_decay=privacybert_weight_decay,
        privacybert_warmup_ratio=privacybert_warmup_ratio,
        privacybert_early_stopping_patience=privacybert_early_stopping_patience,

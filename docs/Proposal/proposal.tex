...
Intermediate, enabling deliverables include a reproducible build pipeline, a unit-test suite covering parsers and chunking, and a small Streamlit/Flask demonstration interface for the validation phase.
...
\begin{table}[hbt]
    ...
    \begin{tabularx}{\linewidth}{@{}l X X@{}}
        ...
        Demonstration interface & Flask / Streamlit web app & Jupyter-only demo --- rejected: not stakeholder-facing. \\
